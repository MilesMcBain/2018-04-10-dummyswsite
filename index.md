...
venue: "QUT Gardens Point"        # brief name of host site without address (e.g., "Euphoric State University")
address: "George St Brisbane"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-27.477677, 153.029844"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/)
humandate: "10 - 11 April, 2018"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9am - 5pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2018-04-10      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2018-04-10        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Miles McBain"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Belinda Weaver"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["miles.mcbain@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
